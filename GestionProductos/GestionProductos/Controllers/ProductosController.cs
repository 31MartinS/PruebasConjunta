...
namespace GestionProductos.Controllers
{
    ...
    public class ProductosController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateProducto([FromBody] Producto producto)
        {
            ...
            if (producto.Stock < 0) return BadRequest("El stock del producto no puede ser negativo.");
            ...
            if (existeProducto != null) return BadRequest("Ya existe un producto con el mismo nombre.");
        ...
        public async Task<IActionResult> EditarProducto(int id, [FromBody] Producto producto)
        {
            ...
            var existeOtroProducto = await _appDbContext.Productos
                .FirstOrDefaultAsync(p => p.Nombre.ToLower() == producto.Nombre.ToLower() && p.Id != id);
            if (existeOtroProducto != null) return BadRequest("Ya existe un producto con el mismo nombre.");
